...
Or pass `--seed <file>` explicitly. Run `npx @inbox-zero/emulate init` to generate a starter file.
...
# or
EMULATE_BASE_URL="https://{service}.myproxy.test" npx @inbox-zero/emulate start
```
